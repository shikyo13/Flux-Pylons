...
public final class QFMenus {
    ...
    public static final Supplier<MenuType<PylonUpgradeMenu>> PYLON_UPGRADES =
            MENUS.register("pylon_upgrades", () -> new net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerType<>((id, inventory, buffer) -> new PylonUpgradeMenu(id, inventory, buffer.readBlockPos())));
