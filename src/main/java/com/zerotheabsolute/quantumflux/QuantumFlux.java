...
public final class QuantumFlux implements ModInitializer {
    ...
    @Override public void onInitialize() {
        ...
        ForgeConfigRegistry.INSTANCE.register(MODID, ModConfig.Type.SERVER, QFConfig.SERVER_SPEC);
        ForgeConfigRegistry.INSTANCE.register(MODID, ModConfig.Type.CLIENT, QFConfig.CLIENT_SPEC);
