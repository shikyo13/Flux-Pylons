...
The JAR is written to `build/libs/`. The 1.20.1 branches use JDK 17. [Release 1.2.0](https://github.com/shikyo13/Flux-Pylons/releases/tag/v1.2.0) includes all five builds.
