...
Use JDK 17 and the included Gradle wrapper. Check out [ZeroMods Core](https://github.com/shikyo13/ZeroMods-Core) at `v0.1.2` in a sibling directory named `ZeroMods-Core` before building:
